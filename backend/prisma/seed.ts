...
async function main() {
  ...
  const roomsData = [
    ...
    },
    {
      ...
      description: "Nestled in our lush, landscaped botanical grounds, the Coastal Garden Villa offers a serene sanctuary focused on wellness. Surrounded by jasmine blossoms and calming waterfalls, it contains a private Zen meditation garden, infrared sauna, and outdoor steam rain shower.",
      price: 650.00,
      capacity: 3,
      bedType: "Queen",
      size: 90,
